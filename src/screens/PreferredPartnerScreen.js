...
import { Title, Wrapper, StyledSubmitButton, Label, InputContainer } from '../styledComponent/index';
...
const PreferredPartnerScreen = ({
  ...
  const handleSubmit = async () => {
    ...
    try {
      const {data} = await axiosInstance.put(`/users/${userId}/preferred-partner`, {
        gender,
        occupation,
        birthYear,
      });

      setUserInfo({preferredPartner : data});
