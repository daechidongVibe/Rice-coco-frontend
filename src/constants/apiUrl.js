...
export default API_URL = {
  googlePlace:
    'https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=37.5059549,127.0590855&radius=3000&type=restaurant',
  randomNickname: 'https://nickname.hwanmoo.kr/?format=json&count=1',
  restaurantList: searchWord =>
    `https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=37.5059549,127.0590855&radius=3000&type=restaurant&keyword=${searchWord}&key=${REACT_NATIVE_GOOGLE_PLACES_API_KEY}`,
